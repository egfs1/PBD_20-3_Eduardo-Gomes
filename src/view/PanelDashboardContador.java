...
import controller.ControllerDashboardContador;
...
public class PanelDashboardContador extends JPanel {
	...
	private JMenuItem mntmDeslogar, mntmSair, mntmMeuPerfil,mntmTabelaSalarioMinimo;
	 ...
	 * Create the panel.
	 */
	public PanelDashboardContador(Long id) {
		this.IDPessoa = id;
		...
		new ControllerDashboardContador(this);
	}
