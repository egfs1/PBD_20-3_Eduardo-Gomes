...
import controller.ControllerEditarIRRF;
...
public class PanelEditarIRRF extends JPanel {
	/**
	 * 
	 */
	...
	public PanelEditarIRRF(TabelaIRRF tabela, ValoresIRRF valor1, ValoresIRRF valor2, ValoresIRRF valor3, ValoresIRRF valor4, ValoresIRRF valor5, Long UserId) {
		...
		btnAtualizar.setBounds(681, 445, 89, 30);
		...
		textFieldValorDeduzir1 = new JTextField(valor1.getValorDeduzir() + "");
		...
		textFieldValorDeduzir2 = new JTextField(valor2.getValorDeduzir() + "");
		...
		textFieldValorDeduzir3 = new JTextField(valor3.getValorDeduzir() + "");
		...
		textFieldValorDeduzir4 = new JTextField(valor4.getValorDeduzir() + "");
		...
		textFieldValorMinimo5 = new JTextField(valor5.getValorMinimo() + "");
		...
		textFieldValorMaximo5 = new JTextField(valor5.getValorMaximo() + "");
		...
		textFieldAliquota5 = new JTextField(valor5.getAliquota() + "");
		textFieldAliquota5.setColumns(10);
		textFieldAliquota5.setBounds(634, 306, 136, 30);
		panel.add(textFieldAliquota5);
		
		textFieldValorDeduzir5 = new JTextField(valor5.getValorDeduzir() + "");
		...
		btnDeletar.setBounds(582, 445, 89, 30);
		panel.add(btnDeletar);
		
		new ControllerEditarIRRF(this);
