...
public class PanelTabela extends JPanel {
	...
	public PanelTabela(AbstractTableModel tableModel, String titulo, int[] aray) {
		...
		table.setPreferredScrollableViewportSize(table.getMaximumSize());
		...
		for (int i = 0; i < columnModel.getColumnCount(); i++) {
			...
			columnModel.getColumn(i).setMinWidth(aray[i]);
		}
